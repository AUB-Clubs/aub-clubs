  ...
  return (
    <div className="bg-background text-primary dark:text-foreground font-sans min-h-screen flex flex-col antialiased selection:bg-primary/20 selection:text-primary">
        ...
        <div className="w-full px-6 lg:px-12 xl:px-40 py-12 lg:py-24">
          <div className="max-w-[1280px] mx-auto grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            <div className="flex flex-col gap-10 lg:order-1 order-2">
              <Card className="border-0 shadow-none bg-transparent">
                <CardContent className="p-0 space-y-6">
                  <h1 className="text-5xl md:text-6xl lg:text-[5.5rem] font-extrabold tracking-tight leading-[1] text-primary">
                    Join<span className="text-foreground">.</span>
                    <br />
                    Lead<span className="text-foreground">.</span>
                    <br />
                    Discover
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-2">
                    <Link href="/me">
                      <Button className="group relative flex items-center justify-center h-16 px-10 rounded-full bg-primary text-primary-foreground text-lg font-bold shadow-2xl shadow-primary/30 hover:shadow-primary/40 hover:-translate-y-0.5 transition-all duration-300 w-full sm:w-auto">
            ...
            <div className="relative lg:order-2 order-1 group">
              ...
              <Card className="relative w-full aspect-[4/5] lg:aspect-square rounded-[2rem] overflow-hidden bg-card/50 shadow-xl border border-white/20">
                <CardContent className="p-0 h-full">
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute bottom-10 left-8 right-8 flex flex-col gap-4">
                      <Card className="bg-card/95 backdrop-blur-md rounded-2xl shadow-2xl border border-white/50 dark:border-white/10 flex items-center gap-4 self-start translate-x-[-10%] opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-700">
                        <CardContent className="p-4 flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-bold text-primary dark:text-foreground leading-tight">
                              Club Fair 2026
                            </p>
                          </div>
                        </CardContent>
                      ...
                      <Card className="bg-card/95 backdrop-blur-md rounded-2xl shadow-2xl border border-white/50 dark:border-white/10 flex items-center gap-4 self-end translate-x-[10%] opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-700 delay-100">
                        <CardContent className="p-4 flex items-center gap-4">
      ...
      <footer className="w-full py-12 border-t border-border">
        <div className="px-6 lg:px-12 xl:px-40 flex flex-col items-center justify-center gap-2 text-sm text-muted-foreground">
